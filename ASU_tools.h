...
double d_rho_x(double);
double d_vp_x(double);
double d_vs_x(double);
...
void   prem_x(double, double *, double *, double *, double *, double *, double *, double *, double *);
...
double r_rho_x(double);
double r_vp_x(double);
double r_vs_x(double);
